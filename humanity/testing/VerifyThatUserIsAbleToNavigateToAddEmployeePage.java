...
public class VerifyThatUserIsAbleToNavigateToAddEmployeePage {

	public static void AddNewEmployeePageTest() throws InterruptedException {
		...
		try {
			...
			if (driver.getCurrentUrl().equals("https://testiranje2.humanity.com/app/staff/add/")){
				System.out.println("User is able to navigate to Add Employee page.");
			}else {
