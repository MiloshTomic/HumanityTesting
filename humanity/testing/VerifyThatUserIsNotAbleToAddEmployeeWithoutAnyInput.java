...
public class VerifyThatUserIsNotAbleToAddEmployeeWithoutAnyInput {
	public static void NothingAddNewEmployeeTest() throws InterruptedException {
		...
		try {
			...
			if (driver.getCurrentUrl().equals("https://testiranje2.humanity.com/app/staff/add/")){
				System.out.println("User is not able to add employee without any input.");
			}else {
