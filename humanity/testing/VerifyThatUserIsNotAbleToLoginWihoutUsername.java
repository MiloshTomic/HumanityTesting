...
public class VerifyThatUserIsNotAbleToLoginWihoutUsername {
	public static void NoUsernameTest( ) {
		...
		try {
			...
			if (driver.getCurrentUrl().equals("https://www.humanity.com/app/")){
				System.out.println("User is not able to log in without username.");
			}else {
