...
public class VerifyThatUserIsAbleToAddEmployeeWithOnlyFirstName {
	public static void OnlyFirstNameNewEmployeeTest() {
		...
		try {
			...
			List<WebElement> radnik= driver.findElements(By.xpath("//a[contains(text(),'" + "Borivoje" + "')]"));
			Assert.assertTrue(radnik.size() > 0, "Employee is added with only first name");
