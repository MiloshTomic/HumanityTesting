...
public class VerifyThatUserIsNotAbleToAddEmployeeWithOnlyEmail {
	public static void OnlyEmailAddNewEmployeeTest() throws InterruptedException {
		...
		try {
			...
			HumanityStaff.InputEmail(driver, "asdtrewe@email.com");
			HumanityStaff.clickSaveEmployee(driver);
			
			Thread.sleep(3000);
			
			if (driver.getCurrentUrl().equals("https://testiranje2.humanity.com/app/staff/add/")){
				System.out.println("User is not able to add employee with only email.");
			}else {
